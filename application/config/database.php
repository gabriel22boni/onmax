...
$db['producao']['username'] 		= 'onmaxcom_orange';
$db['producao']['password'] 		= 'HpcPB6VK?OMg';
$db['producao']['database'] 		= 'onmaxcom_orange';
...
$db['localhost']['database'] 		= 'maxfamac_orange';
...
$db['development']['username'] = 'onmaxcom_orange';
$db['development']['password'] = 'HpcPB6VK?OMg';
$db['development']['database'] = 'onmaxcom_orange';
