<form id="form1" name="form1" method="post" action="<?php echo BASE_URL_ADMIN.'/'.$router_class.'/update_status'; ?>">      
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td align="right" style="min-width:260px;"><table width="370" border="0" align="right" cellpadding="0" cellspacing="0">
        <tr>
          <td width="53" align="center" valign="middle"><a href="<?php echo BASE_URL_ADMIN; ?>/cadastro/exportar" target="_blank"><img src="<?php echo base_url();?>_img/admin/excel.gif" border="0"/><br/>Exportar</a></td>
          <td width="201">Busca:
            ...
            <input type="submit" name="btn_buscar" id="btn_buscar" class="btn_buscar" value="" /></td>
        </tr>
      </table></td>
