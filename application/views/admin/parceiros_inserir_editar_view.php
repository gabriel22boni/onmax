  ...
  <tr>
    <td valign="top">
      <form action="<?=BASE_URL_ADMIN.'/'.$router_class.'/'.$action_form.'_action'?>" class="editar_inserir_view" method="post" name="form_<?=$router_class?>" id="form_<?=$router_class?>" enctype="multipart/form-data">
        ...
        <textarea name="descricao" type="text" id="descricao" size="100" cols="75" rows="3" value="<?php echo @$row->descricao;?>"><?php echo @$row->descricao;?></textarea>
...
<?php } ?>
        ...
        <div style="color:#333;">Imagem com tamanho máximo de 580 x 435 pixels, JPG, GIF ou PNG, formato RGB, 72 dpi</div>
