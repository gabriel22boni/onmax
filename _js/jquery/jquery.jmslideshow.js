(function( $, undefined ) {
	...
	$.JMSlideshow.defaults 		= {
		...
		// slideshow on / off
		autoplay	: false,
		// te between transitions for the slideshow
		interval	: 3500
    };
	...
	$.JMSlideshow.prototype 	= {
		_init 				: function( options ) {
			...
			this._initpress();
			// if support (function plemented in jmpress plugin)
			if( this.support ) {
		...
		_startSlideshow		: function() {
			...
			this.slideshow	= setTeout( function() {
